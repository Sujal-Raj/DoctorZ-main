...
export const createBill = async (req: Request, res: Response) => {
  try {
    const {
      ...
      patientId,
      admissionId,
      items, // Array of { name, quantity, unitPrice, inventoryItemId }
      tax,
      discount,
      insuranceClaimed,
      insuranceProvider,
...
export const getBillsList = async (req: Request, res: Response) => {
  try {
...
export const processInsuranceClaim = async (req: Request, res: Response) => {
  try {
    const { billId } = req.params;
