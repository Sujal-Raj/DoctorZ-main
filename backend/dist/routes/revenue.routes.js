...
import { getDoctorEarnings, getClinicRevenue, getReceptionistCollections, getLabRevenue, updatePaymentStatus } from "../controllers/revenue.controller.js";
import { verifyToken, verifyClinicToken, receptionistVerifyToken, verifyLabToken } from "../middlewares/auth.js";
const router = Router();
// Doctor Earnings
