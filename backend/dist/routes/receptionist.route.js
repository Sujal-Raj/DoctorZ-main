...
bookToken);
router.get("/clinic-patients", receptionistVerifyToken, getAllClinicPatients);
router.get("/profile", receptionistVerifyToken, getProfile);
router.put("/clinic-patients/:bookingId", receptionistVerifyToken, updateClinicPatient);
